...
public class MqttConsumerToKafkaProducer {
	...
	public static void main(String[] args) throws Exception {
		...
		boolean exit = false;
                //Event Loop to receive packets continously.
		while (!exit) {
			...
			KeyedMessage<String, String> kafkaMessage = new KeyedMessage<String, String>(message.getTopic() , strPayload);
                        ...
                        // Simple acknowledge to confimr kafka received MQTT packet
                        connection.publish("ack", "Kafka recived Successfully".getBytes(), QoS.AT_MOST_ONCE, exit);
